...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ItemHolder> {
    ...
    public ItemHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        switch (viewType) {
            case 0:
                View v0 = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.songs_list_item, null);
                ItemHolder ml0 = new ItemHolder(v0);
                return ml0;
            case 1:
                View v1 = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.album_grid_item_searchview, null);
                ItemHolder ml1 = new ItemHolder(v1);
                return ml1;
            case 2:
                View v2 = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_artist_searchview, null);
            ...
            case 10:
                ...
                return ml10;
            default:
                View v3 = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.songs_list_item, null);
        ...
        switch (getItemViewType(i)) {
            case 0:
                ...
                try {
                    ...
                    Glide.with(mContext).load(R.drawable.defualt_art2)
                            .apply(new RequestOptions().format(DecodeFormat.PREFER_ARGB_8888))
                            .into(itemHolder.albumArtSong);
                }
            ...
            case 1:
                ...
                itemHolder.albumtitle.setText(album.getAlbumTitle());
            ...
            case 2:
                ...
                itemHolder.artisttitle.setText(artist.getArtistName());
    ...
    public class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        protected TextView titleSong, songartist, albumtitle, artisttitle, albumartist, albumsongcount, sectionHeader;
        protected ImageView albumArtSong, albumArtAlbum, artistImage, menu;

        public ItemHolder(View view) {
            super(view);

            this.titleSong = (TextView) view.findViewById(R.id.song_item_name);
            this.songartist = (TextView) view.findViewById(R.id.song_item_artist);
            this.albumArtSong = view.findViewById(R.id.song_item_img);

            this.artisttitle = (TextView) view.findViewById(R.id.artist_item_name);

            this.albumtitle = (TextView) view.findViewById(R.id.album_list_name);
            this.albumartist = (TextView) view.findViewById(R.id.album_list_artist);
            this.albumArtAlbum = (ImageView) view.findViewById(R.id.album_list_img);
        ...
        public void onClick(View v) {
            switch (getItemViewType()) {
                case 0:
                    ...
                    MyApp.getMyService().playSongById(song.getSongId());
                    break;
                case 1:
                    NavigationUtils.gotoAlbum(mContext, ((Album) searchResults.get(getAdapterPosition())).getAlbumId());
                    break;
                case 2:
                    //NavigationUtils.gotoAlbum(mContext, ((Artist) searchResults.get(getAdapterPosition())).getArtistId());
                    break;
                case 3:
                    break;
                case 10:
